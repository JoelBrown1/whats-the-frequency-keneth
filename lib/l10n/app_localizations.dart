...
abstract class AppLocalizations {
  ...
  /// Active measurement state: arming
  ///
  /// In en, this message translates to:
  /// **'Arming…'**
  String get measureArming;

  /// Active measurement state: capturing
  ///
  /// In en, this message translates to:
  /// **'Capturing…'**
  String get measureCapturing;

  /// Active measurement state: analysing
  ///
  /// In en, this message translates to:
  /// **'Analysing…'**
  String get measureAnalysing;

  /// Active measurement state: generic fallback
  ///
  /// In en, this message translates to:
  /// **'Working…'**
  String get measureWorking;

  /// Active measurement state: playing sweep pass N of M
  ///
  /// In en, this message translates to:
  /// **'Playing sweep {pass} of {total}…'**
  String measurePlayingSweep(int pass, int total);

  /// Title for the discard result confirmation dialog
  ///
  /// In en, this message translates to:
  /// **'Discard result?'**
  String get discardResultTitle;

  /// Body text for the discard result confirmation dialog
  ///
  /// In en, this message translates to:
  /// **'This measurement will not be saved. Are you sure?'**
  String get discardResultContent;

  /// Button to clear the overlay measurement
  ///
  /// In en, this message translates to:
  /// **'Clear'**
  String get overlayMeasurementClear;

  /// Title for the save measurement dialog
  ///
  /// In en, this message translates to:
  /// **'Save measurement'**
  String get saveMeasurementTitle;

  /// Label for the pickup name text field
  ///
  /// In en, this message translates to:
  /// **'Pickup label'**
  String get pickupLabelField;

  /// Hint text for the pickup name text field
  ///
  /// In en, this message translates to:
  /// **'e.g. PAF neck'**
  String get pickupLabelHint;

  /// Label above the existing pickup dropdown in save dialog
  ///
  /// In en, this message translates to:
  /// **'Link to existing pickup (optional):'**
  String get linkExistingPickup;
  ...
  /// Checkbox label to create a new pickup entry
  ///
  /// In en, this message translates to:
  /// **'Create new pickup'**
  String get createNewPickup;
  ...
  /// History screen title when in selection mode
  ///
  /// In en, this message translates to:
  /// **'Select measurement'**
  String get historySelectMeasurement;

  /// Placeholder name for pickups with no label
  ///
  /// In en, this message translates to:
  /// **'Unnamed pickup'**
  String get historyUnnamedPickup;

  /// Final button in onboarding to begin measuring
  ///
  /// In en, this message translates to:
  /// **'Start Measuring'**
  String get startMeasuring;

  /// Section heading for the audio interface picker in setup screen
  ///
  /// In en, this message translates to:
  /// **'Audio Interface'**
  String get setupAudioInterfaceSection;

  /// Error: DSP pipeline threw during analysis
  ///
  /// In en, this message translates to:
  /// **'Signal processing failed. Please retry.'**
  String get errorDspFailed;

  /// Button label to start chain calibration
  ///
  /// In en, this message translates to:
  /// **'Calibrate'**
  String get calibrateButton;

  /// Progress label during chain calibration sweep
  ///
  /// In en, this message translates to:
  /// **'Sweeping… (pass {pass} of {total})'**
  String calibrationSweeping(int pass, int total);

  /// Title shown when chain calibration fails
  ///
  /// In en, this message translates to:
  /// **'Calibration failed'**
  String get calibrationFailed;

  /// Button to dismiss a calibration error and retry
  ///
  /// In en, this message translates to:
  /// **'Try again'**
